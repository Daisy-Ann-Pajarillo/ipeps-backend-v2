        ...
        for application in applications:
            ...
            if job_posting:
                ...
                result.append({
                    ...
                    "no_of_vacancies": job_posting.no_of_vacancies,
                    "other_skills": job_posting.other_skills,
        ...
        for application in applications:
            ...
            if scholarship_posting:
                ...
                result.append({
                    ...
                    "occupied_slots": scholarship_posting.occupied_slots,
                    "status": application.status,
        ...
        for application in applications:
            ...
            if training_posting:
                ...
                result.append({
                    ...
                    "occupied_slots": training_posting.occupied_slots,
                    "status": application.status,
